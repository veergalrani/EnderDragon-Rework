...
execute if entity @s[scores={rcube.dragonRework_customDragonPhase=8}] in minecraft:the_end at @s run function rcube:dragon_rework/attacks/mad/miniboss/summon